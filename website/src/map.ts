...
const SCALE_DOMAINS = {
    // Jobs
    "population": { 'max': 504, 'color': '#531827', 'max_ratio': 0.020217088327393808 * SQUARED_METER_TO_KM},
    'no_selection': { 'min': 0, 'max': 1 },
    'administration': { 'min': 1, 'max': 17, 'color': "#8068cb", 'max_ratio': 0.081340 },
    'agricole': { 'min': 3, 'max': 122, 'color': "#62b257", 'max_ratio': 0.657143 },
    'artisanat': { 'min': 2, 'max': 93, 'color': "#b84dcf", 'max_ratio': 0.308081 },
    'commerce': { 'min': 6, 'max': 44, 'color': "#cf5288", 'max_ratio': 0.135000 },
    'construction': { 'min': 1, 'max': 39, 'color': "#b19436", 'max_ratio': 0.135458 },
    'rente': { 'min': 5, 'max': 140, 'color': "#598ad6", 'max_ratio': 0.412979 },
    'service': { 'min': 1, 'max': 77, 'color': "#d1583d", 'max_ratio': 0.158103 },

    // Origins 
    "not_lausanne": { 'max': 288, 'color': '#9e2846', 'max_ratio': 0.6571428571428571 },
    "aigle": { 'max': 8, 'color': '#9e2846', 'max_ratio': 0.032609 },
    "angleterre": { 'max': 14, 'color': '#9e2846', 'max_ratio': 0.041298 },
    "aubonne": { 'max': 10, 'color': '#9e2846', 'max_ratio': 0.030303 },
    "avenches": { 'max': 3, 'color': '#9e2846', 'max_ratio': 0.014354 },
    "cossonay": { 'max': 17, 'color': '#9e2846', 'max_ratio': 0.065217 },
    "echallens": { 'max': 12, 'color': '#9e2846', 'max_ratio': 0.045455 },
    "france": { 'max': 21, 'color': '#9e2846', 'max_ratio': 0.093264 },
    "fribourg": { 'max': 6, 'color': '#9e2846', 'max_ratio': 0.085714 },
    "geneve": { 'max': 6, 'color': '#9e2846', 'max_ratio': 0.017699 },
    "grandson": { 'max': 2, 'color': '#9e2846', 'max_ratio': 0.010870 },
    "italie": { 'max': 3, 'color': '#9e2846', 'max_ratio': 0.010050 },
    "la_vallee": { 'max': 14, 'color': '#9e2846', 'max_ratio': 0.400000 },
    "lausanne": { 'max': 149, 'color': '#9e2846', 'max_ratio': 0.540230 },
    "lavaux": { 'max': 53, 'color': '#9e2846', 'max_ratio': 0.106195 },
    "morges": { 'max': 26, 'color': '#9e2846', 'max_ratio': 0.092527 },
    "moudon": { 'max': 13, 'color': '#9e2846', 'max_ratio': 0.055276 },
    "neuchatel": { 'max': 3, 'color': '#9e2846', 'max_ratio': 0.011858 },
    "nyon": { 'max': 10, 'color': '#9e2846', 'max_ratio': 0.043478 },
    "orbe": { 'max': 10, 'color': '#9e2846', 'max_ratio': 0.035587 },
    "oron": { 'max': 15, 'color': '#9e2846', 'max_ratio': 0.059289 },
    "payerne": { 'max': 4, 'color': '#9e2846', 'max_ratio': 0.021739 },
    "pays_d_enhaut": { 'max': 11, 'color': '#9e2846', 'max_ratio': 0.038278 },
    "rolle": { 'max': 8, 'color': '#9e2846', 'max_ratio': 0.020202 },
    "suisse_allemande": { 'max': 36, 'color': '#9e2846', 'max_ratio': 0.100503 },
    "vaud": { 'max': 6, 'color': '#9e2846', 'max_ratio': 0.085714 },
    "vevey": { 'max': 15, 'color': '#9e2846', 'max_ratio': 0.045226 },
    "yverdon": { 'max': 12, 'color': '#9e2846', 'max_ratio': 0.072464 },
}
