...
const DEFAULT_PACKING_TEXT = "Pour une immersion encore plus poussée dans le Lausanne du XIX<sup>ème</sup> siècle, découvrez notre carte interactive. Chaque division de la ville est délimitée et peut être colorée pour créer une Carte choroplèthe, révélant les concentrations de différentes origines et professions.";
const PACKING_TEXT = {
